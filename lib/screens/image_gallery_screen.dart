...
import 'package:image_gallery/screens/image_show.dart';
...
class _ImageGalleryScreenState extends State<ImageGalleryScreen> {
  ...
  Future<void> _fetchImages(int imageCount) async {
    ...
    try {
      List<ImageModel> fetchedImages =
          await PixabayService.fetchImages(_page, imageCount: imageCount);
      setState(() {
  ...
  int _calculateImagesToLoad() {
    ...
    final double rowHeight =
        150; // Approximate height for an image with padding and info
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ImageShow(image: image,)));
                    },
